...
@Weave(originalName = "oracle.cloud.connector.impl.soap.HttpTransportServlet")
public abstract class HttpTransportServlet_Instrumentation extends BaseTransportServlet_Instrumentation {
