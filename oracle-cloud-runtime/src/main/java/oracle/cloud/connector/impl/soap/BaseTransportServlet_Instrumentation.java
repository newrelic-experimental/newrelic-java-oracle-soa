...
@Weave(type = MatchType.BaseClass, originalName = "oracle.cloud.connector.impl.soap.BaseTransportServlet")
public abstract class BaseTransportServlet_Instrumentation {
