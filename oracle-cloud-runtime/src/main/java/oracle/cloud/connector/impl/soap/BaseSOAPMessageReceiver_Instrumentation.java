...
@Weave(type = MatchType.BaseClass, originalName = "oracle.cloud.connector.impl.soap.BaseSOAPMessageReceiver")
public abstract class BaseSOAPMessageReceiver_Instrumentation implements SOAPMessageReceiver {
	
	@NewField
	protected Token token = null;
	
	@WeaveAllConstructors
	public BaseSOAPMessageReceiver_Instrumentation() {
		if(token == null) {
