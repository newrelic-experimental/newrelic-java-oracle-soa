...
@Weave(type = MatchType.Interface, originalName = "oracle.integration.platform.blocks.mesh.MessageHandler")
public abstract class MessageHandler_Instrumentation {
